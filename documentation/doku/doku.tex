...
\section{Dateisynchronisationsdienst Synchrony}
...
\caption{Screenshot der Weboberfläche}		% Bildbeschriftung
...
\caption{Bild x von Information Y}									% Bildbeschriftung
...
Einkommentieren!
%\includegraphics[scale=1.0]{pics/giesecke_devrient_ger.png}		% Grafikeinbindung mit Dateiname und Groessenangabe													% ([width=], [height=], [scale=1.00]...)
\caption{Bild als Tabelle deklariert}									% Bildbeschriftung
\label{fig:LogoGD}												% Sprungmarke fuer Verweise
\end{table}
