...
\begin{itemize}
\item Der Anwendungszweck ist nicht identisch mit P2P (BitTorrent), d.h. kein Filesharing-Protokoll, das sich besonders für die schnelle Verteilung großer Datenmengen eignet.
\end{itemize}
\newpage
