...
%		citecolor=black, %standard green
...
\textsf{\large{Stand: 11.05.2010}}\\
\vspace*{20pt}
\\ 

Teilnehmer: \hspace*{0.5cm}Simon Bauer, Michael Bien, Siegfried Hable,\\
\hspace*{2.75cm}Benedikt Lippert, Markus Grundl\\
%\vspace*{6pt}
...
Datei-Synchronisation zwischen zwei Rechner (kein Mount!)
\subsection{Optionale Kriterien}
- Server: 'Social Sharing' - Mechanismus\\
- Anbindung mobiler Clients (Android)\\
- Anbindung an etablierte Protokolle
\subsection{Zielabgrenzung}
- Anwendungszweck nicht identisch mit P2P (BitTorrent)
\newpage
\section{Produkteinsatz}
\subsection{Anwendungsbereich}
Paar Sätze im Prosa, was die SW tun soll.
\subsection{Zielgruppe}
Anwender, die Dateien zwischen zwei Geräten synchron halten wollen.\\
Bsp: Entwickler, Photographen ...
\subsection{Betriebsbedingungen}
- Systemdienst, im Hintergrund aktiv mit der User-Session des Anwenders\\
- Wartungsfrei\\
- User hat Steuerungspflicht
\newpage
\section{Produktumgebung}
Produktumgebung
\subsection{Software}
Software:\\
-allg.: kompatibles Filesystem\\
- Desktop: \hspace*{2cm} -NW-Anschluss \\-Java 7 RE\\
- Mobiler Client: \hspace*{2cm} -aktuelles Android-BS mit Unterstützung der SW \\-Nw-Verbindung (wireless)
\subsection{Hardware}
